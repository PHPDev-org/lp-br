...
<noscript><div><img src="https://mc.yandex.ru/watch/75016273" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
                    ...
                    <div class="landing-cost__item">
                        <div class="landing-cost__inner">
                            ...
                            <div class="landing-cost__msg">
								В сеть МТС – 0,019 руб. (до 01.05); 0,023 руб. (с 01.05.).
                            </div>
                            <div class="landing-cost__msg">
                                В сети др. операторов – 0,021 руб (до 01.05); 0,026 руб. (с 01.05.).
                            </div>
<div class="landing-cost__msg">
                                Во все сети РБ – 0,0204 руб (до 01.05); 0,025 руб. (с 01.05.).
                            </div>
                            <div class="landing-cost__msg">
                    ...
                    <div class="landing-cost__item">
                        <div class="landing-cost__inner">
                           ...
                           <div class="landing-cost__msg">
                               ...
                               Сервисное сообщение – 0,0115 руб.
                            </div>
                            <div class="landing-cost__msg">
                               Рекламное сообщение – 0,035 руб.
                            </div>
                            <div class="landing-cost__msg">
                             Абонентская плата за альфа-имя – 650 руб./мес.**
                            </div>
                            <div class="landing-cost__add">
                                *Все тарифы приведены в белорусских рублях с учетом НДС.<br>
                    ...
                    <div class="offers__item">
                        <div class="offers__in">
                            ...
                            <div class="offers__price">
                                193
                                <span>руб. (до 1.05)</span>
                            </div>
                            <div class="offers__price">
                                237,5
                                <span>руб. (с 1.05)</span>
                            </div>
                ...
                <div class="landing-calc__wrap">
                    <div class="landing-calc__form">
                        <form action="#" method="post">
							...
							<div class="landing-calc__item">
                                <div class="landing-calc__label">SMS во все сети РБ</div>
                                <input type="text" maxlength="5" id="smsAll" placeholder="0">
                            </div>

                            <style>
                                .landing-calc__item input[type="text"]{
                                    transition: opacity .3s ease;
                                }
                                .landing-calc__item input[type="text"]:disabled{
                                    opacity: 0.4;
                                }
                            </style>
                            <div class="landing-calc__item">
                ...
                <div class="accordeon">
                    ...
                    <div class="accordeon__item">
                        ...
                        <div class="accordeon__info">
                            ...
                            <p>
                                Также платформа будет удобной для всех, кто рассылает много сообщений — для мелкого, среднего и крупного бизнеса.
                            </p>
                        </div>
                    </div>
                    <div class="accordeon__item">
                        ...
                        <div class="accordeon__info">
                            <div class="table-wrap">
                                <table>
                                    ...
                                    <tr>
                                        <td>в сеть МТС  - 0,019 BYN (до 01.05); 0,023 руб. (с 01.05.)</td>
                                        <td>сервисное сообщение - 0,0115 BYN</td>
                                    </tr>
                                    <tr>
                                        <td>в другие сети - 0,021 BYN (до 01.05); 0,026 руб. (с 01.05.)</td>
                                        <td>рекламное сообщение - 0,0135 BYN</td>
                                    </tr>
                                    <tr>
                                        <td>в другие страны - 0,35 BYN</td>
                                        <td>Абонентская плата – 650 BYN. Включает стоимость сервисных и рекламных сообщений</td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <div class="accordeon__item">
                        ...
                        <div class="accordeon__info">
                            ...
                            *Порядок утверждения альфа-номера и правила текста рассылки смотрите в <a href="https://www.mts.by/corp/biznes-i-it-resheniya/reklama-i-privlechenie-klientov/sms-rassylka/mts-biznes-rassylki/">Правилах оказания услуг</a>.<br>
